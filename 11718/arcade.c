...
#pragma config(Motor,  port2,           DriveRight_1,  tmotorServoContinuousRotation, openLoop)
...
#pragma config(Motor,  port6,           DriveRight_2,  tmotorServoContinuousRotation, openLoop)
