...
void autoDrive(int x) {
  ...
  frontLeft.move_velocity(x);
  frontRight.move_velocity(x);
  backLeft.move_velocity(x);
  backRight.move_velocity(x);
}
...
Motor intake(6, E_MOTOR_GEARSET_06, false, E_MOTOR_ENCODER_DEGREES);
