	...
	if(bIfiRobotDisabled == true)
	{
		...
		while(nLCDButtons != centerButton)
		{
			...
			case 0:
				...
				displayLCDCenteredString(0, "DISABLED __ 1");
			...
			case 1:
				...
				displayLCDCenteredString(0, "DISABLED __ 2");
				displayLCDCenteredString(1, "<         Enter        >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 2:
				...
				displayLCDCenteredString(0, "DISABLED __ 3");
				displayLCDCenteredString(1, "<         Enter        >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 3:
				...
				displayLCDCenteredString(0, "DISABLED __ 4");
				displayLCDCenteredString(1, "<         Enter        >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 5:
				//Display fourth choice
				displayLCDCenteredString(0, "DISABLED __ 5");
				displayLCDCenteredString(1, "<         Enter        >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 6:
				//Display fourth choice
				displayLCDCenteredString(0, "DISABLED __ 6");
				displayLCDCenteredString(1, "<         Enter        >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
...

{
	...
	case 4:
		...
		wait(.8);
		move(0);
		while(SensorValue[leftQuad] > -1375) {
			move(-127);
		}
		move(0);
		wait(.2);
		...
		//wait(0.9);
		SensorValue[leftQuad] = 0;
		while(SensorValue[leftQuad] < 1660) {
			move(127);
		}
		move(-127);
		wait(.05);
	...
	case 5:
		...
		displayLCDCenteredString(0, "Red front backup");
		displayLCDCenteredString(1, "is running!");
		SensorValue[leftQuad] = 0;
		motor[flywheel] = -127;
		while(SensorValue[leftQuad] < 1100) { //move forward to get first ball
			move(100);
			motor[frontRoller] = 127;
		}
		move(0);
		...
		SensorValue[leftQuad]=0;
		SensorValue[gyro] = 0;
		startTask(turn90); //turn left
		wait(1);

		SensorValue[leftQuad] = 0;
		while(SensorValue[leftQuad] < 145) //move for first shot
		{
			move(60);
		}
		move(0);
		...
		SensorValue[leftQuad] = 0;
		while(SensorValue[leftQuad] < 325) {   //second shot
			move(60);
		}
		move(0);
		motor[indexer] = 127;
