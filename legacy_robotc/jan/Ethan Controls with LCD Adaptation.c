...
void pre_auton()
{
	...
	while(nLCDButtons != centerButton)
	{
		...
		case 0:
			...
			displayLCDCenteredString(0, "RedCF");
		...
		case 1:
			...
			displayLCDCenteredString(0, "RedCFP");
			displayLCDCenteredString(1, "<         Enter        >");
			waitForPress();
			//Increment or decrement "count" based on button press
			if(nLCDButtons == leftButton)
		...
		case 2:
			...
			displayLCDCenteredString(0, "RedBCFP");
			displayLCDCenteredString(1, "<         Enter        >");
			waitForPress();
			//Increment or decrement "count" based on button press
			if(nLCDButtons == leftButton)
		...
		case 3:
			...
			displayLCDCenteredString(0, "RedBCF");
			displayLCDCenteredString(1, "<         Enter        >");
			waitForPress();
			//Increment or decrement "count" based on button press
			if(nLCDButtons == leftButton)
...
task autonomous() {
	...
	case 5:
		...
		displayLCDCenteredString(0, "BlueCFP");
		displayLCDCenteredString(1, "is running!");
		//Put in code here directly without braces		break;
	case 6:
		//If count = 2, run the code correspoinding with choice 3
		displayLCDCenteredString(0, "BlueBCFP");
		displayLCDCenteredString(1, "is running!");
