...
#pragma config(Motor,  port4,           DriveLeft_1,   tmotorServoContinuousRotation, openLoop)
...
#pragma config(Motor,  port7,           liftMotors,    tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port8,           wheelMotors,   tmotorServoContinuousRotation, openLoop)
